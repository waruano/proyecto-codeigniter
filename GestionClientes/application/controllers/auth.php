			...
			if ($this->form_validation->run()) {								// validation ok
				if (!is_null($data = $this->tank_auth->change_email(
					...
					foreach ($errors as $k => $v)	$data['errors'][$k] = $this->lang->line($v);
                        ...
                        $data['auth']='auth/send_again_form';
                        $this->load->view('masterPage',$data);
			...
			if ($this->form_validation->run()) {								// validation ok
				if (!is_null($data = $this->tank_auth->forgot_password(
					...
					foreach ($errors as $k => $v)	$data['errors'][$k] = $this->lang->line($v);
                        ...
                        $this->template->write_view('login','auth/forgot_password_form',$data);
	...
	function reset_password()
	{
		...
		if ($this->form_validation->run()) {								// validation ok
			...
			if (!$this->tank_auth->can_reset_password($user_id, $new_pass_key)) {
                ...
                $data['auth']='auth/reset_password_form';
                $this->load->view('masterPage',$data);
			...
			if ($this->form_validation->run()) {								// validation ok
				if ($this->tank_auth->change_password(
					...
					foreach ($errors as $k => $v)	$data['errors'][$k] = $this->lang->line($v);
                        ...
                        $data['auth']='auth/change_password_form';
                        $this->load->view('masterPage',$data);
			...
			if ($this->form_validation->run()) {								// validation ok
				if (!is_null($data = $this->tank_auth->set_new_email(
					...
					foreach ($errors as $k => $v)	$data['errors'][$k] = $this->lang->line($v);
                        ...
                        $data['auth']='auth/change_email_form';
                        $this->load->view('masterPage',$data);
			...
			if ($this->form_validation->run()) {								// validation ok
				if ($this->tank_auth->delete_user(
					...
					foreach ($errors as $k => $v)	$data['errors'][$k] = $this->lang->line($v);
                        ...
                        $data['auth']='auth/unregister_form';
                        $this->load->view('masterPage',$data);
