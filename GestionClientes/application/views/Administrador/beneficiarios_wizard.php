            ...
            <div>
                <table>
                    <?php if (intval($total_beneficiarios) < intval($plan_beneficiarios)) { ?>
                        <tr>
                            <td><h4>Total de Beneficiarios:  </h4> </td>
                            <td><h4><?php echo $total_beneficiarios."/".$plan_beneficiarios; ?></h4></td>
                        </tr>
                    <?php } else { ?>
                        <tr>
                            <td><h4>Total de Beneficiarios:  </h4> </td>
                            <td><h4 style="color: red"><?php echo $total_beneficiarios."/".$plan_beneficiarios; ?></h4></td></tr>
                        <tr><td colspan="2"><h5 style="color: red">Ha alcanzado su limite de beneficiarios, 
                                Los Beneficiarios extra tendrán un costo adicional</h5></td></tr>
                    <?php } ?>
                </table>
            </div>
