...
<div class="flexigrid crud-form" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
    ...
    <div class="row " style="border: 1px solid #69bd43; padding-left: 10px; color: #fff; background-color: #69bd43;
        ...
        <strong><?php echo $this->l('form_add'); ?> <?php echo $subject ?></strong>
    </div>
    <div id='main-table-box'>
        ...
        <div class="row" style="border: 1px solid #ccc; border-top: 0px;  text-align: center; font-size: 18px; 
            ...
            <?php
            break;
        case 'anteriorContratos':
            ?>
            <div class='form-button-box'>
                <input type='button' value='Siguiente' id="save-and-go-back-button"  class="btn btn-large"/>
            </div>
            <div class='form-button-box'>
                <input type='button' value='Regresar' class="btn btn-large" id="regresar-contratos" 
                       onclick="window.location = '<?php echo base_url() ?>contratos/index/add'"/>
            </div>
            <div class='clear'></div>
            <?php
            break;
