...
class Tank_auth
{
	...
	function logout()
	{
		...
		$this->ci->session->set_userdata(array('user_id' => '', 'username' => '', 'status' => '', 'rol'=>''));
	...
	function get_username()
	{
        ...
        function get_sidebar(){
            ...
            switch ($rol){
                case 1:
                    $sidebar='Administrador/sidebar';
                    break;
                case 2:
                    $sidebar='Digitador/sidebar';
                    break;
                case 3:
                    $sidebar='Cajero/sidebar';
                    break;
                case 4:
                    $sidebar='Consultor/sidebar';
                    break;
                default:
                    $sidebar='pages/sidebar_home';
                    break;
            }
            return $sidebar;
        }
