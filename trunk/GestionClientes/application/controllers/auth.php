...
class Auth extends CI_Controller {
    ...
    function send_again() {
        if (!$this->tank_auth->is_logged_in(FALSE)) {       // not logged in or activated
            ...
            $this->template->write('title', 'Previmed');
            $this->template->write_view('sidebar', 'pages/sidebar_home');
            $this->template->write_view('content', 'auth/send_again_form');
            $this->template->render();
    ...
    function forgot_password() {
        if ($this->tank_auth->is_logged_in()) {         // logged in
            ...
            $this->template->write('title', 'Previmed');
            $this->template->write_view('sidebar', 'pages/sidebar_home');
            $this->template->write_view('content', 'auth/forgot_password_form');
            $this->template->render();
    ...
    function reset_password() {
        ...
        $this->template->write('title', 'Previmed');
        $this->template->write_view('sidebar', 'pages/sidebar_home');
        $this->template->write_view('content', 'auth/reset_password_form');
        $this->template->render();
    ...
    function change_email() {
        if (!$this->tank_auth->is_logged_in()) {        // not logged in or not activated
            ...
            $this->template->write('title', 'Previmed');
            $this->template->write_view('sidebar', 'pages/sidebar_home');
            $this->template->write_view('content', 'auth/change_email_form');
            $this->template->render();
    ...
    function unregister() {
        if (!$this->tank_auth->is_logged_in()) {        // not logged in or not activated
            ...
            $this->template->write('title', 'Previmed');
            $this->template->write_view('sidebar', 'pages/sidebar_home');
            $this->template->write_view('content', 'auth/unregister_form');
            $this->template->render();
    ...
    function _mostrar_mensaje($message) {
        $this->session->set_flashdata('message', $message);
    }
