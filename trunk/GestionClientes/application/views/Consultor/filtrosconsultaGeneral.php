...
<div class="row" style="padding-top: 5px;" >
    ...
    <div class="col-md-3"> 
        <?php
        echo form_dropdown($eps['name'], $eps['options'], $eps['value'], 'style="width:215px; height: 26px; "');
        ?>
...
<div class="row" style="padding-top: 5px; padding-bottom: 5px;" >
    ...
    <div class="col-md-3"> 
        ...
        <?php
        echo form_dropdown($ciudad['name'], $ciudad['options'], $ciudad['value'], 'style="width:215px; height: 26px; "');
        ?>
        <div style="color: red;"><?php echo form_error($ciudad['name']); ?><?php echo isset($errors[$ciudad['name']]) ? $errors[$ciudad['name']] : ''; ?>        </div>
    </div>   
    <div class="col-md-1">         
